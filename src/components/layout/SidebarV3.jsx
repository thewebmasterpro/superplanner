...
export default function SidebarV3() {
    ...
    return (
        <aside data-tour="sidebar-nav" className="md:col-span-3 lg:col-span-2 card backdrop-blur-xl bg-black/50 shadow-xl shadow-purple-500/20 border-r border-white/20 h-full min-h-[500px]">
