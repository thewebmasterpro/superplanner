    ...
    const renderWidget = (id, title, icon, component) => {
        ...
        return (
            <SortableWidget key={id} id={id} isEditing={isEditing}>
                <div className={`group/widget card bg-base-100 shadow-xl border-2 transition-all duration-300 h-full ${!isEnabled ? 'opacity-40 grayscale border-dashed border-base-300' : 'border-base-300 hover:border-primary/30 hover:shadow-2xl'
                    }`}>
    ...
    return (
        <DashboardLayoutV3>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 animate-slide-up delay-200">
                <section data-tour="dashboard-chart" className="card bg-base-100 shadow-xl border border-base-300">
                ...
                <section id="task-section" data-tour="dashboard-tasks" className="card bg-base-100 shadow-xl border border-base-300 xl:col-span-2 overflow-visible">
                    <div className="card-body p-6">
