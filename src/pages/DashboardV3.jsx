    ...
    const renderWidget = (id, title, icon, component) => {
        ...
        return (
            <SortableWidget key={id} id={id} isEditing={isEditing}>
                <div className={`group/widget card backdrop-blur-xl bg-white/5 shadow-xl border transition-all duration-300 h-full ${!isEnabled ? 'opacity-40 grayscale border-dashed border-white/10' : 'border-white/10 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/20 hover:bg-white/10'
                    }`}>
    ...
    return (
        <DashboardLayoutV3>
            ...
            <section id="stats-section" data-tour="dashboard-stats" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 animate-stagger-fast">
                <div className="stats shadow-lg shadow-purple-500/10 backdrop-blur-xl bg-white/5 border border-white/10 hover:border-purple-500/50 hover:shadow-purple-500/20 transition-all">
                    <div className="stat">
                ...
                <div className="stats shadow-lg shadow-purple-500/10 backdrop-blur-xl bg-white/5 border border-white/10 hover:border-purple-500/50 hover:shadow-purple-500/20 transition-all">
                    <div className="stat">
                        <div className="stat-title opacity-70">Complétées</div>
                ...
                <div className="stats shadow-lg shadow-purple-500/10 backdrop-blur-xl bg-white/5 border border-white/10 hover:border-purple-500/50 hover:shadow-purple-500/20 transition-all">
                    <div className="stat">
                        <div className="stat-title opacity-70">Productivité</div>
                        <div className="stat-value text-accent font-display">{isLoading ? '...' : `${productivity}%`}</div>
                    </div>
                </div>
                <div className="stats shadow-lg shadow-purple-500/10 backdrop-blur-xl bg-white/5 border border-white/10 hover:border-purple-500/50 hover:shadow-purple-500/20 transition-all">
                    <div className="stat">
                        <div className="stat-title opacity-70">Critiques</div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 animate-slide-up delay-200">
                <section data-tour="dashboard-chart" className="card backdrop-blur-xl bg-white/5 shadow-xl shadow-purple-500/10 border border-white/10 hover:border-purple-500/50 hover:shadow-purple-500/20 transition-all">
                ...
                <section id="task-section" data-tour="dashboard-tasks" className="card backdrop-blur-xl bg-white/5 shadow-xl shadow-purple-500/10 border border-white/10 hover:border-purple-500/50 hover:shadow-purple-500/20 transition-all xl:col-span-2 overflow-visible">
                    <div className="card-body p-6">
